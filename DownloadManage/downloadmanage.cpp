...
int DownloadManage::ProcessDownload()
{
    ...
    {
        PyTuple_SetItem(pArgs, 0, PyUnicode_FromString(m_DownData->DownloadValue->at(i).base_url.toStdString().c_str()));
        PyTuple_SetItem(pArgs, 2, PyUnicode_FromString(path.c_str()));
